...
#define KELVINATOR_BASIC_FAN_MAX ((uint8_t)3U)
...
#define KELVINATOR_FAN_MAX ((uint8_t)5U)
...
#define KELVINATOR_MIN_TEMP ((uint8_t)16U)  // 16C
#define KELVINATOR_MAX_TEMP ((uint8_t)30U)  // 30C
